  ...
  <div>
    <div>
      <el-table
        ...
        align="left"
      >
        <el-table-column fixed width="50px" label="序号" prop="id"></el-table-column>
        <el-table-column fixed label="手机品牌" prop="brand"></el-table-column>
        <el-table-column
          fixed
          ...
          prop="specs"
        ></el-table-column>
        <el-table-column fixed label="系统" prop="system"></el-table-column>
        <el-table-column fixed label="系统版本" prop="system_version"></el-table-column>
        <el-table-column fixed label="手机配置" prop="config"></el-table-column>
        <el-table-column
          show-overflow-tooltip="true"
          label="序列号/IMEI"
          min-width="125px"
